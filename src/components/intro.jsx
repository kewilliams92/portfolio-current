  ...
  return (
    <div className="flex items-center justify-center flex-col text-center pt-20 pb-12">
      ...
      <p className="text-sm max-w-xl mb-6 font-bold dark:text-white">
        ...
        <br />
        Check out my{' '}
        <a href="https://www.linkedin.com/in/kevin-e-williams" target="_blank" className="text-cyan-600 hover:underline underline-offset-2 decoration-2 decoration-red-600" rel="noreferrer noopener">LinkedIn</a> to learn more about my professional experience and technical skills, and <a href="https://www.upwork.com/freelancers/~01bdb2f0dd833b3520?mp_source=share" target="_blank" className="text-cyan-600 hover:underline underline-offset-2 decoration-2 decoration-red-600" rel="noreferrer noopener">Upwork</a> to view my prices and reviews.
      </p>
    </div>
  )
}
